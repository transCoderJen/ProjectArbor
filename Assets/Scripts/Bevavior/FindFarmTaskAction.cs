...
namespace ShiftedSignal.Garden.Behavior
{
    ...
    [NodeDescription(name: "Find Farm Task", story: "[Unit] finds [FarmTarget] and [FarmTask]", category: "Action/Units", id: "0e6ab5a8ab42d7298626639b4f7377a5")]
    public partial class FindFarmTaskAction : Action
    {
        ...
        protected override Status OnStart()
        {
            ...
            FarmTarget.Value = bestBlock.gameObject;
