...
public class Occludable : MonoBehaviour
{
    ...
    private float currentTargetShadowClipThreshold = 0.2f;
    ...
    {
        float targetAlpha = isOccluded ? TransparentAlpha : 1f;
        float targetShadowClipThreshold = isOccluded ? OccludedShadowClipThreshold : VisibleShadowClipThreshold;
